    ...
    <div className=" p-4 fixed left-0 bg-white z-50 right-0 ">
      <header className=" flex justify-between items-center  ">
        ...
        <div className=" flex space-x-4 items-center md:space-x-6 ">
          ...
          <img className=" cursor-pointer h-6" src={elipsis} alt="elipsis" onClick={() => {
              setBoardType("edit");
          ...
          {isElipsisMenuOpen && (
            ...
            <ElipsisMenu type="Boards" setOpenEditModal={setOpenEditModal} setOpenDeleteModal={setOpenDeleteModal} />
          )}
        </div>
